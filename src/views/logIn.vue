            ...
            <form action="" class="form" @submit.prevent="login">
                ...
                <div class="form__content">
                    ...
                    <div class="form__group">
                        ...
                        <input type="password" id="password" class="form__input" name="password" v-model="user.password">
                    ...
                    <div class="form__group form__group--row">
                        <router-link to="/signup" class="register-now">Register Now</router-link>
