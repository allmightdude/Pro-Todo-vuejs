            ...
            <form class="form" @submit.prevent="signup()">
                ...
                <div class="form__content">
                    <div class="form__group">
                        ...
                        <input type="text" class="form__input" name="name" v-model="user.name">
                    </div>

                    <div class="form__group">
                        <label for="title" class="form__label">Email</label>
                        <input type="text" class="form__input" name="email" v-model="user.email">
                    </div>

                    <div class="form__group">
                        <label for="title" class="form__label">Password</label>
                        <input type="password" class="form__input" name="password" v-model="user.password">
                    </div>
                    
                    <div class="form__group">
                        <label for="title" class="form__label">Confirm Password</label>
                        <input type="password" class="form__input" name="password2" v-model="user.password2">
                    </div>
                    ...
                    <div class="form__group form__group--row">
                        <router-link to="/login" class="register-now">Do you have a account?</router-link>
                    </div>
